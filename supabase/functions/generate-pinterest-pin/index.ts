...
Требования:
1) "topic" — короткая, цепляющая тема (астрология ИЛИ нумерология), уместная сегодня.
   ПРИОРИТЕТ: если в "Ближайшие астрособытия" есть событие в течение 7 дней — посвяти пин ему,
   обязательно укажи КОНКРЕТНУЮ ДАТУ из контекста (например, "Новолуние 14 июля" или "Солнце в Лев — 22 июля").
   Не выдумывай свои даты, бери ТОЛЬКО из астроконтекста выше. Если событий нет — опирайся на фазу Луны и знак Солнца.
