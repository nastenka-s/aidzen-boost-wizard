...
const NatalChartCalculator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Натальная карта: Расчет и Расшифровка Онлайн Бесплатно | Нейродзен</title>
        <meta
          name="description"
          content="Узнайте, что такое натальная карта, как ее проверить и получить точный прогноз. Полная характеристика человека по натальной карте и гороскопу. Рассчитайте натальную карту онлайн бесплатно с расшифровкой."
        />
        <meta
          name="keywords"
          content="натальная карта, натальная карта рассчитать, натальная карта онлайн бесплатно, натальная карта расшифровка бесплатно, расшифровка натальной карты онлайн бесплатно, натальная карта составить, что такое натальная карта, натальная карта гороскоп, астрология карта натальная, моя натальная карта, полная натальная карта, разбор натальной карты, натальная карта с расшифровкой, карта натальная, натальный гороскоп"
        />
        <link rel="canonical" href="https://aidzen.ru/natal-chart-calculator" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Натальная карта: Расчет и Расшифровка Онлайн Бесплатно" />
        <meta property="og:description" content="Узнайте, что такое натальная карта, как ее проверить и получить точный прогноз. Полная характеристика человека по натальной карте." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Натальная карта — Расчет и Расшифровка",
            "description": "Бесплатный онлайн калькулятор натальной карты с полной расшифровкой. Узнайте положение планет, значение домов и аспектов в вашем гороскопе рождения.",
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-950 via-purple-900 to-purple-950">
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl font-bold text-center mb-4 text-white">Натальная карта и прогноз</h1>
    ...
    <Card className="bg-transparent border-none shadow-none">
      <CardHeader className="space-y-2">
        ...
        <p className="text-xs sm:text-sm text-purple-200 text-center max-w-xl mx-auto">
          ...
          доступен после регистрации. В личном кабинете вас ждут 30+ астрологических, нумерологических, прогностических
          расчетов.
        </p>
