        ...
        <div className="container mx-auto px-4 lg:px-8 space-y-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg dark:prose-invert mx-auto text-muted-foreground space-y-4">
              <p>
                <strong>Матрица Судьбы</strong> — это уникальная система самопознания, основанная на нумерологии и символике 22 арканов Таро. 
              ...
              <p>
                В отличие от классической астрологии, <strong>матрица судьбы по дате рождения</strong> использует только числа из вашей даты рождения, 
