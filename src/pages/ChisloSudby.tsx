  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Узнайте, как рассчитать число судьбы по дате рождения и понять, что оно значит. Простое объяснение, примеры и рекомендации, как использовать число судьбы в жизни без ошибок." />
        <meta name="keywords" content="число судьбы, как рассчитать число судьбы, значение числа судьбы, нумерология судьбы, число жизненного пути, дата рождения и судьба, расчёт числа судьбы, нумерология по дате рождения" />
        
        <meta property="og:title" content="Число судьбы: как рассчитать и применить в жизни" />
        <meta property="og:description" content="Узнайте, как рассчитать число судьбы по дате рождения и понять, что оно значит. Простое объяснение, примеры и рекомендации." />
      ...
      <article className="container mx-auto px-4 lg:px-8 py-16 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            16 января, 2025 • Время чтения: 9 мин
          </p>
        </div>

        <div className="prose prose-lg max-w-none space-y-8">
          <p className="text-lg leading-relaxed">
            Число судьбы — одно из ключевых понятий в нумерологии. Оно помогает понять, что в человеке заложено изначально: сильные стороны, задачи, тип жизненных испытаний и способ достижения успеха. В этой статье вы научитесь вычислять число судьбы по дате рождения, расшифруете своё значение и поймёте, как использовать эту информацию в повседневной жизни.
          </p>

          <section>
            <h2 className="text-3xl font-bold mb-4">Что такое число судьбы</h2>
            <p className="mb-4">
              Число судьбы (или число жизненного пути) показывает, с какими качествами вы пришли в этот мир и через какие уроки реализуетесь. Это не приговор, а карта маршрута: направление задано, но способ пройти путь — ваш выбор.
            </p>
            ...
            <Card className="p-6 bg-card/50 border-primary/20">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Сигнал:</strong> дата рождения повторяет определённую числовую вибрацию</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <span><strong>Смысл:</strong> эта вибрация определяет общий сценарий и стратегию жизни</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <span><strong>Действие:</strong> когда вы понимаете свой «код судьбы», легче принимать решения в согласии с собой</span>
                </li>
              </ul>
            </Card>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Берём полную дату рождения и складываем все цифры до однозначного числа.
            </p>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  Число судьбы не говорит, кем вы «должны быть». Оно подсказывает, в какой роли вы будете естественнее и сильнее. Например, если у вас число 4, вам ближе стабильность, структура, ответственность. Значит, хаотичные решения или частая смена направлений будет вызывать внутреннее напряжение.
                </p>
              </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <Card className="p-6 bg-card border-border/50">
                ...
                <p>
                  <strong>Анна, 4 июля 1983 → число судьбы 5.</strong> Работала бухгалтером, но часто чувствовала усталость и скуку. Когда перешла в маркетинг и стала вести проекты с командой и путешествиями, почувствовала прилив энергии. Число 5 требует свободы и перемен.
                </p>
              </Card>
              ...
              <Card className="p-6 bg-card border-border/50">
                ...
                <p>
                  <strong>Ирина, 9 марта 1976 → число судьбы 8.</strong> Всегда стремилась к руководящим ролям, но боялась ответственности. После 40 лет начала свой бизнес и признала, что «управлять» — это её природа. Число 8 активируется, когда человек берёт ответственность, а не избегает её.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-3xl font-bold mb-4">TL;DR — Коротко</h2>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
          ...
          <div className="bg-gradient-to-br from-secondary/20 to-primary/20 border border-border rounded-2xl p-8 my-12">
            ...
            <p className="mb-6 text-lg">Начните с готовых мини-результатов за пару минут</p>
            <Button 
              size="lg"
            ...
            <div className="space-y-4">
              <Card className="p-6 bg-card border-border/50">
                ...
                <p className="text-muted-foreground">
                  Сложите все цифры своей даты рождения до однозначного числа (или оставьте 11, 22, 33). Пример: 24.09.1988 → 2+4+0+9+1+9+8+8=41 → 4+1=5.
                </p>
              </Card>
              ...
              <Card className="p-6 bg-card border-border/50">
                ...
                <p className="text-muted-foreground">
                  Выбирайте деятельность, где естественно проявляются качества вашего числа — так вы меньше тратите энергию и быстрее растёте.
                </p>
              </Card>
              ...
              <Card className="p-6 bg-card border-border/50">
                ...
                <p className="text-muted-foreground">
                  Возможно, вы сейчас живёте под влиянием другого цикла — года, месяца или персонального числа. Основное число судьбы проявляется сильнее с возрастом.
                </p>
              </Card>
            </div>
          </section>
