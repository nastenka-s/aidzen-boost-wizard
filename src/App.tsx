...
import ProfessiyaPoDateRozhdeniya from "./pages/blog-auto/ProfessiyaPoDateRozhdeniya";
import DomaGoroskopaZnachenie from "./pages/blog-auto/DomaGoroskopaZnachenie";
import AspektyPlanetVNatalnojKarte from "./pages/blog-auto/AspektyPlanetVNatalnojKarte";
...
import PrizvaniePoNatalnojKarte from "./pages/blog-auto/PrizvaniePoNatalnojKarte";
import StihiiVNatalnojKarte from "./pages/blog-auto/StihiiVNatalnojKarte";
...
import RybyVNatalnojKarte from "./pages/blog-auto/RybyVNatalnojKarte";
...
import FinansovyjPotokMatrica from "./pages/blog-auto/FinansovyjPotokMatrica";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/finansovyj-potok-matrica" element={<FinansovyjPotokMatrica />} />
          ...
          <Route path="/ryby-v-natalnoj-karte" element={<RybyVNatalnojKarte />} />
          ...
          <Route path="/stihii-v-natalnoj-karte" element={<StihiiVNatalnojKarte />} />
          <Route path="/prizvanie-po-natalnoj-karte" element={<PrizvaniePoNatalnojKarte />} />
          ...
          <Route path="/aspekty-planet-v-natalnoj-karte" element={<AspektyPlanetVNatalnojKarte />} />
          <Route path="/doma-goroskopa-znachenie" element={<DomaGoroskopaZnachenie />} />
          <Route path="/professiya-po-date-rozhdeniya" element={<ProfessiyaPoDateRozhdeniya />} />
